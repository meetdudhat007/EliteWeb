...
export function Work() {
    ...
    (ctx, prefersReduced) => {
      ...
      mm.add("(min-width: 1024px)", () => {
        ...
        tl.to(
          ...
          .to(
            "[data-work-step='0']",
            { width: 16, backgroundColor: "rgba(255,255,255,0.2)", duration: 0.35 },
            0.8
          )
          .to(
            "[data-work-step='1']",
            { width: 40, backgroundColor: "#ffffff", duration: 0.35 },
            0.85
          )
          .to(
            "[data-work-counter='0']",
  ...
  return (
    <section
      ref={sectionRef}
      id="work"
      className="relative border-b border-white/[0.07] pt-24 pb-28 sm:pt-32 sm:pb-36 lg:pt-36 lg:pb-40"
    >
      <Container size="wide">
        {/* Section Header */}
        <div className="flex flex-col justify-between gap-6 border-b border-white/[0.07] pb-12 md:flex-row md:items-end">
        ...
        >
          ...
          <div
            ...
            className="hidden items-center justify-between border-b border-white/[0.07] pb-4 mb-8 lg:flex"
          >
                ...
                {siteConfig.projects.map((proj, idx) => (
                  <span
                    ...
                    className={`h-1 rounded-full transition-all duration-300 ${
                      idx === 0 ? "w-10 bg-white" : "w-4 bg-white/20"
                    }`}
                  />
                ))}
              </div>
              ...
              <div className="relative inline-flex h-4 w-6 items-center justify-center overflow-hidden">
                {siteConfig.projects.map((_, idx) => (
                  <span
                    ...
                    className={`absolute font-mono text-xs font-semibold text-white ${
          ...
          >
            {siteConfig.projects.map((project, index) => (
              <article
                ...
                className="relative w-full border-b border-white/[0.07] pb-20 last:border-b-0 last:pb-0 lg:absolute lg:inset-0 lg:h-full lg:border-b-0 lg:pb-0 motion-reduce:lg:relative motion-reduce:lg:inset-auto motion-reduce:lg:h-auto"
              >
