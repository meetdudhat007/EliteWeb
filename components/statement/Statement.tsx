...
export function Statement() {
  ...
  useGSAPAnimation(
    (_ctx, prefersReduced) => {
      ...
      if (isDesktop) {
         ...
         * The left metadata rail is not visible before the right content on mobile
         * (grid collapses to single column), so we only animate the content.
         */
        const tl = gsap.timeline({
          scrollTrigger: {
            trigger: sectionRef.current,
  ...
  return (
    <section
      ref={sectionRef}
      className="relative border-b border-white/[0.07] bg-[#0c0e12]/80 py-32 sm:py-40 lg:py-48"
    >
        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-12 lg:gap-16">
          ...
          <div className="lg:col-span-3">
            <div className="sticky top-28 space-y-4">
              ...
              <div
                data-statement="meta-line"
                className="h-12 w-[1px] bg-white/10"
              />
            </div>
          </div>
          ...
          <div className="lg:col-span-9">
            ...
            <p
              data-statement="supporting"
              className="mt-8 text-lg font-normal leading-relaxed text-zinc-400 sm:text-xl max-w-3xl"
            >
